...
public class MissingPersonReportService {
    ...
    private void validateMissingPersonReport(MissingPersonReport report) throws SQLException {
        ...
        if (report.getResolvedDatetime() != null && report.getResolvedDatetime().isAfter(LocalDateTime.now())) {
            throw new IllegalArgumentException("Resolved datetime cannot be in the future");
        }
    }
